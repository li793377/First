<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliverCard.aspx.cs" Inherits="MyBBS.CardManage.DeliverCard" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="TableCss"
                ...
                <tr>
                    <td rowspan="1" style="vertical-align: top; width: 215px"></td>
                    <td style="width: 530px; height: 25px; text-align: left"></td>
                </tr>
                <tr>
                    <td style="width: 215px; vertical-align: top;" rowspan="5">
                        <br />
                        <br />
                        <br />
                        <br />
                        ...
                        <table style="width: 195px" border="0" cellpadding="0" cellspacing="0" class="TableCss">
                            ...
                            <tr>
                                <td style="height: 22px">Email：<asp:Label ID="labEmail" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="height: 22px">QQ：<asp:Label ID="labQQ" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="height: 22px">个人主页：<asp:Label ID="labIndex" runat="server"></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                    <td style="width: 530px; text-align: left; height: 25px;">&nbsp;帖子名称：<asp:TextBox ID="txtCName" runat="server" Width="441px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="width: 530px; text-align: left; height: 25px;">&nbsp;所属版块：<asp:DropDownList ID="ddlMName" runat="server" Width="150px">
                    </asp:DropDownList></td>
                </tr>
                <tr>
                    <td style="width: 530px; text-align: left; height: 22px;">&nbsp;内 &nbsp;&nbsp;容：</td>
                </tr>
                <tr>
                    <td style="width: 530px; vertical-align: top; height: 190px;">
                ...
                <tr>
                    <td style="width: 530px; height: 38px;">
