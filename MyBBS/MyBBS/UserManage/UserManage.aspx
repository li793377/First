<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManage.aspx.cs" Inherits="MyBBS.UserManage.UserManage" %>
...
<body>
    ...
    <div>
        <table align="center" style="width: 794px; height: 489px; background-image: url(../Images/大背景.jpg);" class="TableCss" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="height: 300px; vertical-align: top;"><br /><br /><br />
                    <asp:GridView ID="gvUserInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gvUserInfo_PageIndexChanging"
